      ...
      slides: [
        {
          ...
          html: `<p>«Мы — защита граждан, а не карающий меч революции, как это раньше об органах ВЧК-НКВД говорили,» — слова нового министра внутренних дел Юрия 
                  ...
                  <p>Может ли милиция применять силу? Может, если без силы остановить или задержать человека невозможно. Милиционер обязан предупредить нарушителя, 
        ...
        },
        {
          ...
          html: `<p>атьяна Самникова-Мастыкина вспоминает, как на День Воли в 2018-м ее и других волонтеров Белорусского Хельсинкского комитета задержали в центре Минска 
        ...
        },
        {
          ...
          html: `<h3>Что делать, если милиция применяет силу?</h3>
                  ...
                  <p>В Беларуси были случаи, когда милиционеров привлекали к ответственности за издевательства над подозреваемыми. При этом стоит признать, что часто из СК 
    ...
    initScrollControls () {
      ...
      this.slides.forEach(element => {
        ...
        const slideTween = new TimelineLite()
          ...
          .to(`#${element.id} .slide-background`, 2.3, { css: { '-webkit-filter': 'blur(8px)' }},'bgOpacityFade');
